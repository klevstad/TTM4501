...
Consider 17th of May 1980 as our special date, and that we want all newer dates. In a regular database system supporting date related data types, our query would be something like this on a concatenated date of birth column
...
SELECT *
FROM employee_table
WHERE (year >= 1980 and month >= 5 and day >= 17) OR (year > 1980)
